...
public class DocumentConverterUtil {
	...
	public static List<Document> convertColumnsToDocuments(Integer datasourceId, String agentId, List<TableInfoBO> tables) {
	 ...
	 */
	public static Document convertColumnToDocument(Integer datasourceId, String agentId, TableInfoBO tableInfoBO,
	 ...
	 */
	public static Document convertTableToDocument(Integer datasourceId, String agentId, TableInfoBO tableInfoBO) {
	...
	public static List<Document> convertTablesToDocuments(Integer datasourceId, String agentId, List<TableInfoBO> tables) {
