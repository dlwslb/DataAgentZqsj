...
public class DateUtils {
     ...
     * 获取本周开始时间
     */
    public static LocalDateTime getWeekStartTime(LocalDateTime now) {
     ...
     * 获取本月结束时间
     */
    public static LocalDateTime getMonthEndTime(LocalDate now) {
     ...
     * 获取今年结束时间
     */
    public static LocalDateTime getYearEndTime(LocalDate now) {
        return now.with(TemporalAdjusters.lastDayOfYear()).atTime(LocalTime.MAX);
    }
