...
public interface ChatMessageMapper {
	...
	@Insert("""
			INSERT INTO chat_message (session_id, role, content, message_type, metadata, user_id, tenant_id, create_time)
			VALUES (#{sessionId}, #{role}, #{content}, #{messageType}, #{metadata}, #{userId}, #{tenantId}, NOW())
			""")
